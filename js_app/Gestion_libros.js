class Gestion_libros extends GestionEntidad {
    ...
    static async createForm_ADD() {
        ...
        document.getElementById('nuevo_archivopdfL').setAttribute('onblur', 'Gestion_libros.comprobar_archivopdfL()');
        document.getElementById("label_archivopdfL").style.display = 'none';
        document.getElementById("archivopdfL").style.display = 'none';
        document.getElementById("link_archivopdfL").style.display = 'none';
    ...
    static createForm_EDIT(datostupla) {
        ...
        document.getElementById('PaisEdicionL').setAttribute('onblur', 'Gestion_libros.comprobar_PaisEdicionL');
        document.getElementById('nuevo_archivopdfL').setAttribute('onblur', 'Gestion_libros.comprobar_archivopdfL()');
        document.getElementById('archivopdfL').setAttribute("readonly", "");
    ...
    static createForm_DELETE(datostupla) {
        ...
        document.getElementById("label_nuevo_archivopdfL").style.display = 'none';
        document.getElementById("nuevo_archivopdfL").style.display = 'none';
    ...
    static comprobar_submit() {
        ...
        let valor11 = this.comprobar_archivopdfL();
    ...
    static comprobar_archivopdfL() {
        debugger;
        if (validacionesatomicas.nombre_min('nuevo_archivopdfL', 4)) {
            if (validacionesatomicas.termina_con('nuevo_archivopdfL', '.pdf')) { }
            else {
                DOM_class.mostrardivmensajeserrordebajo('nuevo_archivopdfL', 'KO_archivopdfL_formato')
                return false;
            }

            if (validacionesatomicas.nombre_max('nuevo_archivopdfL', 20)) { }
            else {
                //modificacion parametros texto error
                DOM_class.mostrardivmensajeserrordebajo('nuevo_archivopdfL', 'KO_archivopdfL_nom_max');
                //salir ejecucion con false
                return false;
            }
            if (validacionesatomicas.file_size_maximo('nuevo_archivopdfL', 200000)) { }
            else {
                //modificacion parametros texto error
                DOM_class.mostrardivmensajeserrordebajo('nuevo_archivopdfL', 'KO_archivopdfL_tam_max');
                //salir ejecucion con false
                return false;
            }
            DOM_class.mostrarexitovalor('nuevo_archivopdfL');
            return true;
        }
    }
    ...
    static recargarform() {
        ...
        <br>        
        <label id="label_archivopdfL" class="label_archivopdfL">Archivo PDF</label>
        ...
        <label id="label_nuevo_archivopdfL" class="label_nuevo_archivopdfL">Nuevo Archivo PDF</label>
        <input type='file' id='nuevo_archivopdfL' name='nuevo_archivopdfL' accept='application/pdf'></input>
        <div id="div_error_nuevo_archivopdfL" class="errorcampo"><a id="error_nuevo_archivopdfL"></a></div>
        <br>
    ...
    static recargarform_search() {
        ...
        <a id="link_archivopdfL" href="http://193.147.87.202/ET2/filesuploaded/files_archivopdfL/"><img src="./iconos/FILE.png" /></a>
        <label id="label_nuevo_archivopdfL" class="label_nuevo_archivopdfL">Nuevo Archivo PDF</label>
        <input type='file' id="nuevo_archivopdfL" accept='application/pdf' name='nuevo_archivopdfL'></input>
        <div id="div_error_nuevo_archivopdfL" class="errorcampo"><a id="error_nuevo_archivopdfL"></a></div>
        <br>
